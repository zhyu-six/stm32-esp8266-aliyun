...
//WEB端
//#define  PRODUCTKEY           "a1HdDTHXVco"                                 //产品ID
//#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
//#define  DEVICENAME           "D002"                                  			//设备名  
//#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
//#define  DEVICESECRE          "HfmVeXoIGJbdubU4A19T7ehaLylI49uJ"            //设备秘钥   
//#define  DEVICESECRE_LEN      strlen(DEVICESECRE)  
//#define  S_TOPIC_NAME         "/sys/a1HdDTHXVco/D002/thing/service/property/set"   						//需要订阅的主题  
//#define  P_TOPIC_NAME         "/sys/a1HdDTHXVco/D002/thing/event/property/post"        				//需要发布的主题    

//APP
//#define  PRODUCTKEY           "a14TB0cJFjt"                                 //产品ID
//#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
//#define  DEVICENAME           "D001"                                  			//设备名  
//#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
//#define  DEVICESECRE          "U2pHzMTnov7cQvDRvHvqrhaQjaTjNnUv"            //设备秘钥   
//#define  DEVICESECRE_LEN      strlen(DEVICESECRE)  
//                         
//#define  S_TOPIC_NAME         "/sys/a14TB0cJFjt/D001/thing/service/property/set"   						//需要订阅的主题  
//#define  P_TOPIC_NAME         "/sys/a14TB0cJFjt/D001/thing/event/property/post"   
 



#define  PRODUCTKEY           "a1f77yZF9oA"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "example_1"                                  			//设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "19fee7f8703dfa93acf217580fb442d5"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)  
                         
#define  S_TOPIC_NAME         "/sys/a1f77yZF9oA/example_1/thing/service/property/set"   						//需要订阅的主题  
